...
/*
 * Calcula a idade com base na data de nascimento no formato brasileiro (dd/mm/aaaa)
 * PS: Funciona no IE e no FireFox
 * Exemplo:
 * var idade = calculaIdade('03/09/1982');
 */
function calculaIdade(dataNasc)
{
	...
	mes = data[1];
	ano = data[2];
	//alert("DATA Nascimento = " + dataNasc + " | Dia = " + dia + " | Mes = " + mes + " | ano = " + ano);
	
	dataAtual = new Date();
	anoAtual = dataAtual.getFullYear();
	mesAtual = dataAtual.getMonth()+1;
	diaAtual = dataAtual.getDate();
	//alert("DATA atual = " + dataAtual + " | Dia = " + diaAtual + " | Mes = " + mesAtual + " | ano = " + anoAtual);
...
/*
 * Checa se a pessoa é de maior com base na data de nascimento no formato brasileiro (dd/mm/aaaa)
 * PS: Funciona no IE e no FireFox
 * Exemplo:
 * if(deMaior('03/09/1982'))
 */

function deMaior(dataNasc)
{
