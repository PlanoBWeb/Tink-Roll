...
commom/img/institucional.jpg" alt="institucional" title="institucional">
                ...
                <div class="col-xs-12 col-sm-7 col-md-7">
                    ...
                    <p class="txt-interna">O mercado está sempre em evolução e na Tink Roll não é diferente, há uma contínua modernização, buscando parcerias sólidas, distribuições e novas linhas de produtos.</p>   
    
                    <h2 class="titulo-interna">Nossa missão:</h2>
                    <p class="txt-interna">Fornecer produtos de qualidade e com rapidez, atendendo os clientes com compromisso e respeito.</p>    


                    <h2 class="titulo-interna">Visão:</h2>
                    <p class="txt-interna">Ser o melhor distribuidor do Brasil, proporcionando soluções e serviços aos seus clientes no segmento industrial. </p>  
                </div>
            </article>    
        </section>
    </div>
