<?php /* Smarty version 2.6.12, created on 2015-11-06 18:08:22
         compiled from admin/produto/relacao.html */ ?>
    ...
    <tr>
        <td>
            <table class="tabela-mostra-dados" cellspacing="2" cellpadding="5" border="0">
                <tr class="no-hover">
                    <td><p class="texto">DESTAQUE</p></td>
                </tr>
                <tr style="background-color:#D5DDE3" height="20">
                    <td class="texto-consulta"><strong>titulo</strong></td>
...
?>
                <tr>
                    ...
                    <td class="texto-consulta" nowrap="nowrap">< <a href="adm_produto.php?acao=visualizar&id=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['id']; ?>
">visualizar</a> > | < <a href="?acao=editar&id=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['id']; ?>
