<?php /* Smarty version 2.6.12, created on 2015-11-06 17:40:59
         compiled from admin/categoria/relacao.html */ ?>
    ...
    <tr>
        <td>
            <table class="tabela-mostra-dados" cellspacing="2" cellpadding="5" border="0">
                <tr class="no-hover">
                    <td><p class="texto">categoria</p></td>
                </tr>
                <tr style="background-color:#D5DDE3" height="20">
                    <td class="texto-consulta"><strong>categoria</strong></td>
...
?>
                <tr>
                    <td class="texto-consulta"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['categoria']; ?>
</td>
